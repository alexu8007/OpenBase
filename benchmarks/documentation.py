...
def assess_documentation(codebase_path: str):
    ...
    details.insert(0, ''.join(["Documentation coverage: ", str(doc_coverage), "%.2f% (", str(documented_entities), "/", str(total_entities), ")"]))
    details.insert(1, ''.join(["Good docstrings: ", str(good_docstrings), "/", str(documented_entities), " (", str(quality_ratio*100), "%.1f%)"]))
